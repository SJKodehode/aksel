...
export default function Example() {
  ...
  function onSubmit(event: React.FormEvent) {
    ...
    const newErrors = {
      aldersgruppe: values.aldersgruppe
        ? ""
        : "Du må velge et aldersgruppe.",
    };
    setErrors(newErrors);
    ...
    return (
      <Page.Block width="lg" gutters>
        <VStack gap="8" align="center">
          <Heading size="large">Bra jobbet!</Heading>
          <Button
            onClick={() => {
              location.hash = "";
              location.reload();
      ...
      <form onSubmit={onSubmit}>
        <VStack gap="8">
          ...
          <RadioGroup
            ...
            value={values.aldersgruppe}
            onChange={(newValue) => {
              setValues({ ...values, aldersgruppe: newValue });
              setErrors({ ...errors, aldersgruppe: "" });
            }}
            error={errors.aldersgruppe}
            >
